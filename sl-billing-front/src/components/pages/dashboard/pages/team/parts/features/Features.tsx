...
interface FeaturesTeamPropsInterface {
  query: TeamType;
...
const FeaturesTeam = (props: FeaturesTeamPropsInterface) => {
  const { query, handleFeature, handleDeleteAllFeature, featurePlan } = props;
                    ...
                    <li key={el._id}>
                      <div className="flex items-center p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                        <input
                          ...
                          disabled={featurePlan.includes(el._id || "")}
                          id={el._id}
                          type="checkbox"
