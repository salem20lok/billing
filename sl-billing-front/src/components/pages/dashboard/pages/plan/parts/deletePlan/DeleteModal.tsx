...
interface DeleteModalInterfaceProp {
  closeModalDelete: Function;
  plan: PlanType;
  handleRefresh: Function;
}

const DeleteModal = (props: DeleteModalInterfaceProp) => {
  const { closeModalDelete, plan, handleRefresh } = props;

  const handleDelete = () => {
    deletePlan(plan._id || "", (res, msg) => {
        ...
        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div className="p-6 text-center">
            ...
            <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
              Are you sure you want to delete this Team : {plan.planName}?
            </h3>
            <button
              onClick={() => closeModalDelete()}
              data-modal-toggle="popup-modal"
