...
import { deleteFeature } from "../../../../../../actions/feature/action";

interface DeleteFeatureModalInterfaceProp {
  closeModalDelete: Function;
  featureState: FeatureType;
  handleRefresh: Function;
}

const DeleteFeature = (props: DeleteFeatureModalInterfaceProp) => {
  const { closeModalDelete, featureState, handleRefresh } = props;

  const handleDelete = () => {
    deleteFeature(featureState._id || "", (res, msg) => {
